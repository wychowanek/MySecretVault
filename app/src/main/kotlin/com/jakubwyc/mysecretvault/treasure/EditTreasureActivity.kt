...
class EditTreasureActivity : AppCompatActivity(), EditTreasureView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val treasure = intent.getParcelableExtra<Parcelable>(getString(R.string.extra_treasure))
        if (treasure != null) {
            presenter.showTreasure(treasure as Treasure)
        }
